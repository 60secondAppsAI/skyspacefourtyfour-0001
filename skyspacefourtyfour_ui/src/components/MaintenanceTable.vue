...
<template>
  ...
  <base-input label="LastServiceDate" type="text" placeholder="Enter LastServiceDate" v-model="maintenanceToAdd.lastServiceDate"></base-input>
  <base-input label="NextServiceDate" type="text" placeholder="Enter NextServiceDate" v-model="maintenanceToAdd.nextServiceDate"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'lastServiceDate',
          visible: true,
          scopedSlots: { customRender: 'lastServiceDate' },
          sorter: true
          //sorter: (a, b) => a.lastServiceDate - b.lastServiceDate,
          //sorter: (a, b) => a.lastServiceDate.localeCompare(b.lastServiceDate),
        },
        {
          title: 'Next Service Date',
		dataIndex: 'nextServiceDate',
          visible: true,
          scopedSlots: { customRender: 'nextServiceDate' },
          sorter: true
          //sorter: (a, b) => a.nextServiceDate - b.nextServiceDate,
          //sorter: (a, b) => a.nextServiceDate.localeCompare(b.nextServiceDate),
        },
      ],
      pagination: {
        current: 1,
